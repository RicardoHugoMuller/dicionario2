              ...
              (
                <View style={{justifyContent:'center', marginLeft:10 }}>
                  <View style={styles.detailsContainer}>
                    <Text style={styles.detailsTitle}> Palavra :{"oi"} </Text>
                  ...
                  <View style={styles.detailsContainer}>
                    <Text style={styles.detailsTitle}> Tipo :{"interjeição"}  </Text>
                    <Text style={{fontSize:18}}>
                  ...
                  <View style={{flexDirection:'row',flexWrap: 'wrap'}}>
                    <Text style={styles.detailsTitle}> Definição :{"Saudação usada para cumprimentar alguém"} </Text>
                    <Text style={{ fontSize:18}}>
